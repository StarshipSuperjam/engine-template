...
publishes onto a suitable Issue as the routine's frozen copy, naming the ordered steps and the files each may
touch — and an open **draft pull request** on a branch. The routine reads that promoted plan and adds
