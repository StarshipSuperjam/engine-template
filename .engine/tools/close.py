...
def handler(payload):
    ...
    # Issue discovery is session-start context, never a turn-close obligation. In particular,
    # old disposable triage records cannot trigger network reads or a provider continuation here.
