...
emit = validate.emit
USAGE = ("Usage: operator_local_references_check.py [-h|--help] [demo]\n\n"
         "Checks local-reference declarations and emits a finding.v1 JSON array. "
         "Environment: ENGINE_RULE_TIER, ENGINE_LOCAL_REFERENCES_PATH.")
