...
class TestRecordedProduct(unittest.TestCase):
    """A manifest recording an external product (a repo different from the one the engine is deployed
...
class TestProductBuildTarget(unittest.TestCase):
    """The engine-mechanic executable build target readers: the manifest reader and the two-state
