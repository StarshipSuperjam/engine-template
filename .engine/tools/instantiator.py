...
FALLBACK_COPY = {
    ...
    "codex-hook-trust": (
        ...
        "a moment: use the Codex CLI /hooks approval browser; do not assume Desktop exposes a Hooks settings "
        "screen. Project trust alone is insufficient. Verify an actual hook event in your task after approval. "
        "The tested Desktop task needed reopening to load its configuration. The VS Code extension does not "
...
_FIRST_RUN_ASSET_FILES = (
    ...
    ".engine/tools/demo_program_intended_order.py",
