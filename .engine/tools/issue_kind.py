...
# (mint nothing). Maintenance and Removal have no fitting native label → None (no label applied),
...
def _demo() -> int:
    ...
    # 6. native projection is a secondary view of the kind (only the four natives; None for two).
