...
def canonical_catalogue(root: str = validate.ROOT) -> str:
    ...
    out = [
        ...
        "classifier places every changed path outside everything the Engine reads, executes, or owns — outside "
        "its corners, its declared root files and its ownership register, with every doubt resolved to the "
