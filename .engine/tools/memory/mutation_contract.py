...
REGISTRY = (
    ...
    _entry("version-availability-cache-write", "boot._write_version_cache", "degraded-health",
           "reversible-mutation", _AUTO, None, "status-records", "atomic-replace",
           ["boot.refresh_version_availability", "boot.mark_version_announced"]),
