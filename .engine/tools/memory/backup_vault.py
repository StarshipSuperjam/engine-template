...
def _consent_prompt(vault_name: str, scope: str) -> str:
    ...
    if scope == "shared":
        return (
            ...
            "    decisions, lessons, and plans it remembers. This includes the saved conversations themselves,\n"
            "    so anything pasted or quoted in a session — code and file contents included — is in that copy.\n"
    ...
    return (
        ...
        "    lessons, and plans it remembers. This includes the saved conversations themselves, so anything\n"
        "    pasted or quoted in a session — code and file contents included — is in that copy.\n"
