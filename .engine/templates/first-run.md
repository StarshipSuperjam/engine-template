...
## A file sits where the engine keeps one of its own control-plane files

You already have a file here: {paths}. This is where the engine keeps one of its own control-plane files (a
