...
- provides:
  ...
  - check: `.engine/check/guardrail-weakening.json`, `.engine/check/protection.json`, `.engine/check/test-cost.json`
  ...
  - doc: `.engine/docs/accepted-hook-qualification.md`, `.engine/docs/ci-assurance.md`, `.engine/docs/getting-started.md`, `.engine/docs/reader-health-recovery.md`, `.engine/docs/result-contracts.md`, `.engine/docs/test-cost-contracts.md`
  ...
  - operation: `.engine/operations/boot-session-start.md`, `.engine/operations/build-continuity.md`, `.engine/operations/build-execution.md`, `.engine/operations/build-implementation.md`, `.engine/operations/build-kickoff.md`, `.engine/operations/build-orchestration.md`, `.engine/operations/build-plan-correction.md`, `.engine/operations/build-product-grounding.md`, `.engine/operations/build-submission.md`, `.engine/operations/build-validation-and-review.md`, `.engine/operations/build-work-dispatch.md`, `.engine/operations/checkout-auto-update.md`, `.engine/operations/close-turn.md`, `.engine/operations/codex-incident-replay.md`, `.engine/operations/codex-settings.md`, `.engine/operations/codex-validation.md`, `.engine/operations/conduct-author.md`, `.engine/operations/control-plane-bootstrap.md`, `.engine/operations/engine-arrival.md`, `.engine/operations/engine-development.md`, `.engine/operations/engine-release.md`, `.engine/operations/engine-remove.md`, `.engine/operations/engine-team-switch.md`, `.engine/operations/engine-upgrade.md`, `.engine/operations/first-run.md`, `.engine/operations/issue-recovery.md`, `.engine/operations/issue-triage.md`, `.engine/operations/knowledge-impact-check.md`, `.engine/operations/memory-migration-trial.md`, `.engine/operations/memory-recall.md`, `.engine/operations/module-add.md`, `.engine/operations/module-remove.md`, `.engine/operations/onboarding-read.md`, `.engine/operations/operating-modes.md`, `.engine/operations/owned-product-build.md`, `.engine/operations/plan-orchestration.md`, `.engine/operations/program-orchestration.md`, `.engine/operations/scoped-agent-orchestration.md`, `.engine/operations/serialized-integration.md`, `.engine/operations/test-performance.md`, `.engine/operations/tune-policy.md`
  - policy: `.engine/policies/attention.md`, `.engine/policies/briefing-budget.md`, `.engine/policies/escalation.md`, `.engine/policies/finding-disposition.md`, `.engine/policies/model-bindings.json`, `.engine/policies/model-routing-postures.json`, `.engine/policies/model-routing.md`, `.engine/policies/session-economy.md`, `.engine/policies/supported-upgrade-matrix.md`, `.engine/policies/test-cost-activation.json`, `.engine/policies/test-cost-calibration.json`, `.engine/policies/test-cost-declarations.json`, `.engine/policies/test-cost-legacy-baseline.json`, `.engine/policies/test-cost-legacy-static.json`, `.engine/policies/test-cost-parity.json`, `.engine/policies/test-cost.json`, `.engine/policies/triage-threshold.md`
  ...
  - template: `.engine/templates/*.md`, `.engine/templates/test-authoring.py`
