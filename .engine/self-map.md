...
- provides:
  ...
  - policy: `.engine/policies/attention.md`, `.engine/policies/briefing-budget.md`, `.engine/policies/escalation.md`, `.engine/policies/finding-disposition.md`, `.engine/policies/model-bindings.json`, `.engine/policies/model-routing.json`, `.engine/policies/model-routing.md`, `.engine/policies/session-economy.md`, `.engine/policies/supported-upgrade-matrix.md`, `.engine/policies/triage-threshold.md`
