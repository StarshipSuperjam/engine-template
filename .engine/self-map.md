...
| `engine-coordination-doorbell` | model-only | operation `.engine/operations/session-coordination.md` (active) | `core` |
| `engine-coordination-read` | model-only | operation `.engine/operations/session-coordination.md` (active) | `core` |
