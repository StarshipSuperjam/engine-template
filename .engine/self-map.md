...
- provides:
  ...
  - doc: `.engine/docs/accepted-hook-qualification.md`, `.engine/docs/ci-assurance.md`, `.engine/docs/getting-started.md`, `.engine/docs/reader-health-recovery.md`, `.engine/docs/result-contracts.md`
